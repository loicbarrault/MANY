...
public class TERcost
{
	 ...
	 */
	protected static String COST_NAME = "Default TERcost";
	/* The cost of matching ref word for hyp word. (They are equal) */
	public double match_cost(Comparable<String> hyp, Comparable<String> ref)
	{
		return _match_cost;
	}
	public double match_cost(Comparable<String> hyp, Comparable<String>[] ref)
	...
	public double substitute_cost(Comparable<String> hyp, Comparable<String> ref)
	{
		return _substitute_cost;  
	}
	public double substitute_cost(Comparable<String> hyp,
			ArrayList<Comparable<String>> ref)
	{
		return _substitute_cost;
	}
	/* The cost of inserting the hyp word */
	public double insert_cost(Comparable<String> hyp)
	{
		return _insert_cost;
	}
	/* The cost of deleting the ref word */
	public double delete_cost(Comparable<String> ref)
	{
		return _delete_cost;
	}
	public double delete_cost(ArrayList<Comparable<String>> ref)
	{
		return _delete_cost;
	}
	...
	public double stem_cost(Comparable<String> hyp, Comparable<String> ref)
	{
		return _stem_cost;
	}
	public double stem_cost(Comparable<String> hyp, ArrayList<Comparable<String>> ref)
	{
		return _stem_cost;
	}
	// If they are synonyms (from WordNet)
	public double syn_cost(Comparable<String> hyp, Comparable<String> ref)
	{
		return _syn_cost;
	}
	public double syn_cost(Comparable<String> hyp, ArrayList<Comparable<String>> ref)
	{
		return _syn_cost;
	}
	...
	public void get_wgt_edit(double[] wgt, char type, Comparable<String> hyp,
	...
	public void set_weights(double[] wgts)
	{
		if ((wgts == null) || (wgts.length < get_num_features()))
		{
			...
			if (wgts != null)
				num_w = wgts.length;
			System.err.println("Invalid number of weights being set: " + num_w
					+ " (need " + get_num_features() + ")");
	...
	public void get_wgt_phrase(double[] wgt, Comparable<String>[] hyp,
			int hstart, int hlen, Comparable<String>[] ref, int rstart, int rlen)
	{
		if (_phraseTable == null)
			return;
		_phraseTable.get_wgt_phrase(7, wgt, hyp, hstart, hlen, ref, rstart,
				rlen);
	}
	public void get_wgt_phrase(double[] wgt, Comparable<String>[] hyp,
			int hstart, int hlen, Comparable<String>[][] ref, int rstart, int rlen)
	...
	public Comparable<String>[] process_input_hyp(String[] in)
	{
		return process_input(in);
	}
	public Comparable<String>[] process_input_ref(String[] in)
	{
		return process_input(in);
	}
	public ArrayList<ArrayList<Comparable<String>>> process_input_cn(String[] in)
	{
		ArrayList<ArrayList<Comparable<String>>> cn = new ArrayList<ArrayList<Comparable<String>>>();
		for(int i=0; i<in.length; i++)
		{
			cn.add(new ArrayList<Comparable<String>>());
			cn.get(i).add(in[i]);
		}
		return cn;
	}
	public ArrayList<ArrayList<Float>> process_input_cn(float[] in)
	{
		ArrayList<ArrayList<Float>> cn = new ArrayList<ArrayList<Float>>();
		for(int i=0; i<in.length; i++)
		{
			cn.add(new ArrayList<Float>());
			cn.get(i).add(in[i]);
		}
		return cn;
	}
	protected Comparable<String>[] process_input(String[] in)
	{
		return (Comparable<String>[]) in;
	}
