...
public class WordNetJAWS extends WordNet.Wrapper
{
	...
	public WordNetJAWS (String wordNetDir) 
	{
		if (!new File(wordNetDir).exists()) {
			System.out.println("ERROR WordNetJAWS : WordNet directory does not exist; this will cause problems! " + wordNetDir);
			System.exit(1);
		}
		//System.err.println("INFO WordNetJAWS : Wordnet dir = "+wordNetDir);
